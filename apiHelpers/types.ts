...
export const isAddSavedChatResponse = (x: any): x is AddSavedChatResponse => {
  return validateObject(x, {
    ...
    figureDataSubstitutions: optional(isArrayOf((y: any) => {
      return validateObject(y, {
        name: isString,
        url: isString,
        uploadUrl: isString
...
export const isDeleteSavedChatRequest = (x: any): x is DeleteSavedChatRequest => {
  return validateObject(x, {
...
export const isDeleteSavedChatResponse = (x: any): x is DeleteSavedChatResponse => {
  return validateObject(x, {
    type: isEqualTo('DeleteSavedChat')
  })
}
